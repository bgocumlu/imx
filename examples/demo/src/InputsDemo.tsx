export function InputsDemo(props: { onClose: () => void }) {
  ...
  return (
    <Window title="Inputs Demo" open={true} onClose={props.onClose}>
      <Column gap={8}>

        <CollapsingHeader label="Text Inputs" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Numeric Inputs" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Vector Inputs" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Selection Widgets" defaultOpen={true}>
          <Column gap={6}>
            ...
            <Selectable label="Double-click to toggle (allowDoubleClick)" selected={sel2} onSelect={() => setSel2(!sel2)} allowDoubleClick={true} />
