  ...
  return (
    <TreeNode label="Canvas">
      ...
      <Canvas width={400} height={300} style={{ backgroundColor: [0.08, 0.08, 0.1, 1.0] }}>
        ...
        <DrawBezierCubic p1={[200, 50]} p2={[240, 20]} p3={[280, 80]} p4={[320, 50]} color={[0.5, 1.0, 0.5, 1.0]} thickness={2} />
        <DrawBezierQuadratic p1={[200, 90]} p2={[260, 60]} p3={[320, 90]} color={[0.5, 0.8, 1.0, 1.0]} thickness={2} />

        <DrawPolyline points={[[200, 130], [230, 110], [260, 150], [290, 120], [320, 140]]} color={[1.0, 0.8, 0.2, 1.0]} thickness={2} />

        <DrawConvexPolyFilled points={[[210, 170], [250, 155], [280, 175], [265, 205], [220, 205]]} color={[0.6, 0.3, 0.9, 0.8]} />
        ...
        <DrawTriangle p1={[20, 250]} p2={[70, 210]} p3={[110, 260]} color={[1.0, 0.5, 0.2, 1.0]} thickness={2} />
      </Canvas>
    </TreeNode>
  );
}
