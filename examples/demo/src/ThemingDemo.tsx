export function ThemingDemo(props: {}) {
  const [preset, setPreset] = useState("dark");

  return (
    <TreeNode label="Theming">

      <CollapsingHeader label="Theme Presets">
      ...
      <CollapsingHeader label="Custom Colors">
        <Theme
          preset="dark"
      ...
      <CollapsingHeader label="Style Overrides">
      ...
      <CollapsingHeader label="Font Switching">
