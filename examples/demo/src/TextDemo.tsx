export function TextDemo(props: { onClose: () => void }) {
  return (
    <Window title="Text Demo" open={true} onClose={props.onClose}>
      <Column gap={8}>

        <CollapsingHeader label="Plain Text" defaultOpen={true}>
          <Text>Normal text</Text>
        </CollapsingHeader>

        <CollapsingHeader label="Colored Text" defaultOpen={true}>
        ...
        <CollapsingHeader label="Disabled Text" defaultOpen={true}>
          <Text disabled>Grayed out / disabled text</Text>
        </CollapsingHeader>

        <CollapsingHeader label="Wrapped Text" defaultOpen={true}>
        ...
        <CollapsingHeader label="Colored + Wrapped Text" defaultOpen={true}>
        ...
        <CollapsingHeader label="BulletText" defaultOpen={true}>
        ...
        <CollapsingHeader label="Bullet + SameLine + Text" defaultOpen={true}>
          <Bullet />
          <SameLine spacing={4} />
          <Text>Standalone bullet with text placed via SameLine</Text>
        </CollapsingHeader>

        <CollapsingHeader label="LabelText" defaultOpen={true}>
