export function SlidersDemo(props: { onClose: () => void }) {
  ...
  return (
    <Window title="Sliders & Drags Demo" open={true} onClose={props.onClose}>
      <Column gap={8}>

        <CollapsingHeader label="Sliders" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Vertical Sliders" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Drags" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Vector Sliders" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Vector Drags" defaultOpen={true}>
          <Column gap={6}>
