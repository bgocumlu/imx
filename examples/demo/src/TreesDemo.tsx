  ...
  return (
    <Window title="Trees Demo" open={true} onClose={props.onClose}>
      <Column gap={8}>
        ...
        <CollapsingHeader label="Basic Trees" defaultOpen={true}>
          <Column gap={4}>
        ...
        <CollapsingHeader label="Tree Flags" defaultOpen={true}>
          <Column gap={4}>
        ...
        <CollapsingHeader label="Programmatic Control" defaultOpen={true}>
          <Column gap={6}>
        ...
        <CollapsingHeader label="Collapsing Headers" defaultOpen={true}>
          <Column gap={4}>
