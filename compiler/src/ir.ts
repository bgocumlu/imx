...
export interface IRSameLine { kind: 'same_line'; offset: string; spacing: string; loc?: SourceLoc; }
export interface IRNewLine { kind: 'new_line'; loc?: SourceLoc; }
export interface IRCursor { kind: 'cursor'; x: string; y: string; loc?: SourceLoc; }
...
export interface IRCombo { kind: 'combo'; label: string; stateVar: string; valueExpr?: string; onChangeExpr?: string; directBind?: boolean; items: string; dynamicItems?: boolean; width?: string; style?: string; item?: IRItemInteraction; loc?: SourceLoc; }
...
export interface IRListBox { kind: 'list_box'; label: string; stateVar: string; valueExpr?: string; onChangeExpr?: string; directBind?: boolean; items: string; dynamicItems?: boolean; width?: string; style?: string; item?: IRItemInteraction; loc?: SourceLoc; }
